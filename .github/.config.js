...
async function getOptions() {
  let options = await config({
    types: [
      ...
      { type: "ifeat", section: "New Features (internal)", hidden: true },
      { type: "ifix", section: "Bug Fixes (internal)", hidden: true },
      { type: "iperf", section: "Performance Improvements (internal)", hidden: true },
      { type: "iui", section: "UI/UX Changes (internal)", hidden: true },
      { type: "idocs", section: "Documentation (internal)", hidden: true },
      { type: "irevert", section: "Reverts (internal)", hidden: true },
