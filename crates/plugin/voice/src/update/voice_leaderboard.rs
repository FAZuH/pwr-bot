...
use pwr_plugin_support::pagination::PaginationModel;
...
pub enum VoiceLeaderboardMsg {
    ...
    /// Set the reference time used by subsequent range queries and views.
    SetReferenceTime(DateTime<Utc>),
...
pub enum VoiceLeaderboardEffect {
    ...
    QueryLeaderboard {
        /// The reference time used to build the query range.
        now: DateTime<Utc>,
...
impl Default for VoiceLeaderboardModel {
    fn default() -> Self {
        Self {
            ...
            user_rank: None,
            user_duration: None,
            time_range: VoiceLeaderboardTimeRange::default(),
